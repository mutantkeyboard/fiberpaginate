...
// go test -run Test_PaginateConfig
func Test_PaginateConfig(t *testing.T) {
	t.Parallel()
	app := fiber.New()
	app.Use(New(Config{
		DefaultPage:  100,
...
// go test -run Test_PaginateNegativeConfigValues
func Test_PaginateNegativeConfigValues(t *testing.T) {
	t.Parallel()
	app := fiber.New()
	app.Use(New(Config{
		DefaultPage:  -1,
